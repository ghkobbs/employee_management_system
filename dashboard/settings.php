	...
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<?php if($usertype == "Admin"){ ?>
				...
				<li class="nav-item"><a href="../dashboard/add_user"><span class="nav-icon"><i class="fa fa-user"></i></span>Add User</a></li>
			<?php		} ?>
			<li class="nav-item current"><a href="../dashboard/settings"><span class="nav-icon"><i class="fa fa-cog"></i></span>Settings</a></li>
